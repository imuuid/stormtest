//Write GUI
document.getElementById("mainContainer").innerHTML = "<div class='loader-wrapper hidden'> <img class='loader' src=''></div><div> <div class='container d-flex justify-content-center'> <div id='guiMain' class='guiBox shadow'> <div id='guiMainTitle' class='titleBar'> <span> <p class='spacer circle red' onclick='closeGui()'></p><p class='spacer circle yellow'></p><p class='spacer circle green'></p></span> </div><img class='' src=''> <div class='cpsControl'> <p id='cpsValue'>CPS: 14</p><input type='range' id='cps_range' name='cpsSet' min='1' max='25' value='14'step='1' oninput='updateRange(this.value)'> </div><div class='keyBindControl'> <p class='spacer'>KEYBIND</p><button id='buttonKey' class='spacer buttonGui' onclick='waitingKeypress()'>R</button> </div><div class='bottomGui'> <button class='buttonGui' onclick='closeGui()'>Close</button> <a href='https://t.me/stehack' target='_blank'><i class='float-end spacer fa-brands fa-telegram'></i></a> <a href='https://github.com/stehack27/storm' target='_blank'><i class='float-end spacer fab fa-github'></i></a> </div></div></div></div>";
